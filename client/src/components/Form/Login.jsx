            ...
            <div className="divide-y divide-gray-200">
              <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                <div className="relative ">
                  ...
                  <label htmlFor="email" className="absolute left-0 -top-9 text-gray-600 text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-440 dark:peer-placeholder-shown:text-white peer-placeholder-shown:top-1 transition-all peer-focus:-top-3.5 peer-focus:text-gray-600 dark:peer-focus:text-white peer-focus:text-sm">Email Address</label>
                </div>
                <div className="relative">
